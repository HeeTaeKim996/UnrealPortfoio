...
{
	UMeleeTraceShape_Line* NewShape = NewObject<UMeleeTraceShape_Line>(); // ※ Line Doesnt Need Parameters
	return NewShape; 
}
...
{
	UMeleeTraceShape_Sphere* NewShape = NewObject<UMeleeTraceShape_Sphere>();
...
{
	UMeleeTraceShape_Capsule* NewShape = NewObject<UMeleeTraceShape_Capsule>();
	NewShape->Radius = Radius;
...
{
	UMeleeTraceShape_Box* NewShape = NewObject<UMeleeTraceShape_Box>();
