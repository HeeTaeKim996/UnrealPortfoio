...
// ※ Below classes are only for Blueprint User. c++ user doesnt need them
...
struct MELEETRACE_API FAsyncMeleeHitInfo
{
	...
	UPROPERTY(BlueprintReadOnly, Transient, Category = "Melee Trace Info") // ※ Transient : Can't be saved in Editor. Only Assigned at Runtime
...
public:
	...
	static UAsync_WaitForMeleeTraceEvent* WaitForMeleeTraceEventHit(UObject* WorldContextObject,
		AActor* ActorToWatch);

	virtual void Cancel() override;

	DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FAsyncWaitForMeleeHitDetected,
		FAsyncMeleeHitInfo, HitInfo, FMeleeTraceInstanceHandle, TraceHandle);
