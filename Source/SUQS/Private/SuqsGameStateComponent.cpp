...
void USuqsGameStateComponent::BeginPlay()
{
	...
	SetComponentTickEnabled(GetOwner()->HasAuthority()); // In Single Game, Always true
}

void USuqsGameStateComponent::InitServerProgress()
{
	if (ServerProgression == nullptr && GetOwner()->HasAuthority())
	{
...
void USuqsGameStateComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
