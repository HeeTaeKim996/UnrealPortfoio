	...
	: Super()
{
	...
	WaypointComponent->OnWaypointEnabledChanged.AddDynamic(this, &ASuqsWaypointActorBase::OnWaypointVisibilityPotentiallyChanged);
	WaypointComponent->OnWaypointIsCurrentChanged.AddDynamic(this, &ASuqsWaypointActorBase::OnWaypointVisibilityPotentiallyChanged);
}
